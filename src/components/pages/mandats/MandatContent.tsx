...
export function MandatContent({
  ...
  return (
    ...
    >
      {/* Colonne principale */}
      <div className={`space-y-2 ${isDrawer ? "" : "lg:col-span-2"}`}>
        {/* Résumé du mandat */}
        <Card className="border-none shadow-none p-0 pb-4">
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between pb-2 border-b">
                <div className="flex items-center gap-2">
                  <img src="/cash.png" alt="Prix Icon" className="h-4 w-4" />
                  <span className="text-sm font-medium text-muted-foreground">
                    Prix estimé TTC
                  </span>
                </div>
        ...
        <Card className="bg-[#F9FAFB]">
          <CardContent>
            <div className="p-2">
              <div className="flex items-start bg-white p-8 rounded-lg justify-between mb-8 px-4">
                <div className="flex flex-col items-center">
                  <div
                    className="w-12 h-12 rounded-full border-2 flex items-center justify-center mb-2"
                    style={{ borderColor: "#186BB0" }}
                  >
                    <img
                      src="/map-pin-alt.png"
                      alt="Départ Icon"
                ...
                <div className="flex-1 flex items-center justify-center px-6">
                  <div className="h-4 w-4 rounded-full bg-[#186BB0]"></div>
                  <div
      ...
      /> */}
          ...
          <CardContent className="space-y-4">
            <div className="relative space-y-3">
              ...
              <div
                className="absolute left-3.5 top-3 bottom-0 w-px border-l border-gray-300"
              ...
              <div className="flex items-center gap-3 relative">
                <img
                  ...
                  alt="Step Icon"
                  className="h-8 w-8 z-10 bg-white rounded-full"
                />
                <div>
        ...
        <Card className="bg-[#F9FAFB]">
          ...
          <CardContent className="space-y-3">
            {/* Bon de livraison */}
            <div className="flex items-center bg-white rounded-lg  justify-between p-2 border rounded">
              <div className="flex items-center gap-2">
                <img
            ...
            {/* Preuve de livraison */}
            <div className="flex items-center bg-white rounded-lg justify-between p-2 border ">
              <div className="flex items-center gap-2">
                <img
