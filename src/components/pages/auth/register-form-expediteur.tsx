...
export function RegisterForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push("/register/expediteur");
      }, 2000);
    } finally {
      setLoading(false);
    }
      ...
      >
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Inscrivez-vous pour expédier vos marchandises
            </p>
          </div>
        ...
        <div className="flex justify-end pt-3 sm:pt-4">
          <Button
            ...
            disabled={loading}
          >
            {loading ? "Création..." : "Créer mon compte Expéditeur"}
          </Button>
        </div>
        ...
        {/* Bouton vers formulaire transporteur */}
